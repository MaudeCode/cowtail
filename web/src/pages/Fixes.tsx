...
const scopeStyle: Record<
  FixScope,
  { bg: string; numColor: string; borderColor: string; activeBg: string }
> = {
  reactive: {
    bg: "bg-outcome-fixed",
...
const statsItems: Array<{
  ...
  },
  {
    ...
    shortLabel: "Wkly",
    numColor: "text-[#3b82f6]",
    activeBorderColor: "border-b-[#3b82f6]",
    activeBg: "bg-[rgba(59,130,246,0.08)]",
  },
  {
    key: "monthly",
    ...
    shortLabel: "Mnth",
    numColor: "text-[#8b5cf6]",
    activeBorderColor: "border-b-[#8b5cf6]",
    activeBg: "bg-[rgba(139,92,246,0.08)]",
  },
];
...
export default function Fixes() {
  ...
  const { data: convexFixes, isPending } = useQuery(convexQuery(api.fixes.getAll, {}));
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mb-2 flex-wrap">
                      <span
                        className={`inline-block font-mono text-[0.6rem] uppercase tracking-[0.08em] whitespace-nowrap px-2 py-[2px] font-medium text-white ${style.bg}`}
                      >
                        {fix.scope}
                      </span>
                    ...
                    {fix.rootCause && (
                      <div className="mb-2">
                        ...
                        <span className="text-[0.8rem] text-gray-400 leading-snug">
                          {fix.rootCause}
                        </span>
                      </div>
                    )}
