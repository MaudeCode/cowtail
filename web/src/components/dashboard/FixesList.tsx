  ...
  return (
    <div className="px-5 py-4 bg-surface border-t border-gray-100">
      ...
      {fixes.map((fix) => (
        <div
          key={fix._id}
          className="mb-4 border-l-[3px] border-l-gray-200 pl-4 pb-3 last:mb-0 last:pb-0"
        >
          <div className="flex items-center gap-3 mb-1.5 flex-wrap">
            <span
              className={`inline-block font-mono text-[0.6rem] uppercase tracking-[0.08em] whitespace-nowrap px-2 py-[2px] font-medium ${scopeStyle[fix.scope]}`}
            >
              {fix.scope}
            </span>
          ...
          <div className="text-[0.85rem] leading-relaxed text-gray-600 mb-1">{fix.description}</div>
