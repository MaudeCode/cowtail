...
export default function Button({ active, variant = 'filter', onClick, children, className = '' }: ButtonProps) {
  ...
  const variants = {
    filter: {
      ...
      active: 'font-sans text-xs font-medium uppercase tracking-wide px-4 py-1.5 border-txt bg-txt text-bg',
    },
    preset: {
      ...
      active: 'font-mono text-[0.65rem] uppercase tracking-wide px-3 py-1 border-accent bg-accent text-white',
    },
  };
